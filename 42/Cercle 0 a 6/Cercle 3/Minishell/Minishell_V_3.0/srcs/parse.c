...
/*   Updated: 2023/08/11 12:02:38 by sdestann         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_quote2(t_data *d)
{
	...
	d->var->i++;
	last_i = ft_find_char(d->original_prompt, d->var->i, d->var->quote_type);
	if (last_i > 0)
	{
		d->var->str = ft_substr(d->original_prompt, d->var->i, last_i);
