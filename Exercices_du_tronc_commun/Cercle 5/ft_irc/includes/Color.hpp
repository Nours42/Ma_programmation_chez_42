...
# define BLACK		"\033[30"
# define RED		"\033[31"
# define GREEN		"\033[32" // SND_BUFFER
# define YELLOW		"\033[33" // COMMAND
# define BLUE		"\033[34" // PRIVMSG
# define MAGENTA	"\033[35" // JOIN
# define CYAN		"\033[36" // LOGS
# define WHITE		"\033[37"

# define BRIGHT_BLACK 	"\033[90" // == grey
# define BRIGHT_RED		"\033[91" // INVITE
# define BRIGHT_GREEN 	"\033[92" // QUIT
# define BRIGHT_YELLOW	"\033[93" // DELETE
# define BRIGHT_BLUE	"\033[94" 
# define BRIGHT_MAGENTA	"\033[95"	// ERROR
