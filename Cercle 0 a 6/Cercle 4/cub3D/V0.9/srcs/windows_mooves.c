...
/*   Updated: 2023/09/26 19:35:36 by jmetezea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_move_back(t_data *data)
{
	...
	data->check_y = (data->player_y - (int)data->ya + 25) / PXL;
	data->check_x = (data->player_x - (int)data->xa + 25) / PXL;
...
{
	data->anglerad = data->player_orient * (M_PI / 180.00);
	data->xa = 160 * sin(data->anglerad) * (-1);
	data->ya = 160 * cos(data->anglerad);
